				...
				function (e, t) {
					...
					var r = (function () {
						...
						function i(t) {
							t.src &&
								...
								t.addEventListener(
									"click",
									function (e) {
										return w.keyboard && (e.metaKey || e.ctrlKey)
											? y.open(t.src, "_blank")
											: void (function (e) {
													if (((w.target = e), w.target.classList.contains("lightense-open"))) return a();
													r("beforeShow"),
														(w.scrollY = y.scrollY),
														(function (n, r, i) {
															n.addEventListener(r, function e(t) {
																Reflect.apply(i, this, t), n.removeEventListener(r, e);
															});
													...
													(t.onload = function () {
														!(function (e) {
															var t = e.width,
																...
																l =
																	w.target.getAttribute("data-lightense-padding") ||
																	w.target.getAttribute("data-padding") ||
																	w.padding,
															...
															(w.translateX = Math.round(p - h)), (w.translateY = Math.round(b - m));
														})(this),
															(function () {
																w.target.classList.add("lightense-open"),
																	...
																	setTimeout(function () {
																		w.wrap.style.transform =
																			"translate3d(" + w.translateX + "px, " + w.translateY + "px, 0)";
																	}, 20);
																var e = {
																		cubicBezier:
																			w.target.getAttribute("data-lightense-cubic-bezier") || w.cubicBezier,
																		background:
																			w.target.getAttribute("data-lightense-background") ||
																			w.target.getAttribute("data-background") ||
																			w.background,
						...
						function o(e, t) {
							...
							(r.id = e), r.styleSheet ? (r.styleSheet.cssText = t) : r.appendChild(v.createTextNode(t)), n.appendChild(r);
						}
						function a() {
							r("beforeHide"),
						...
						function s(e) {
							e.preventDefault(), 27 === e.keyCode && a();
						}
						return function (e) {
							...
							(n = (function (e) {
								...
								v.querySelector(".lightense-backdrop") ||
									((w.container = v.createElement("div")),
									(w.container.className = "lightense-backdrop"),
									v.body.appendChild(w.container)),
								(function (e) {
									var t = e.length;
									if (t) for (var n = 0; n < t; n++) i(e[n]);
									else i(e);
								})(n);
						};
					})();
		...
		if (
			...
			$ || $e(Kt || _t),
				r &&
					((Ot = r),
					(Dt = "translate"),
					o ? ((Dt += F ? "3d(" : "3d(0px, "), (kt = F ? ", 0px, 0px)" : ", 0px)")) : ((Dt += F ? "X(" : "Y("), (kt = ")"))),
				...
				(function () {
					...
					(Xt += " tns-" + H.axis),
						(V.className += Xt),
						I
							? (((M = O.createElement("div")).id = Yt + "-mw"), (M.className = "tns-ovh"), T.appendChild(M), M.appendChild(j))
							: T.appendChild(j);
					if (dt) {
						var t = M || j;
						t.className += " tns-ah";
				...
				(function () {
					...
					F &&
						(g || $
							? (ki(Mt, "#" + Yt + " > .tns-item", "font-size:" + m.getComputedStyle(G[0]).fontSize + ";", Ri(Mt)),
				...
				je
					...
					: H.autoplayButtonOutput &&
					  (T.insertAdjacentHTML(
							...
							'<button type="button" data-action="' + t + '">' + Ge[0] + t + Ge[1] + bt[0] + "</button>"
					  ),
					...
					r &&
						...
						(function () {
							for (var t = It + Math.min(Q, rt), e = Lt; e--; ) {
								var n = G[e];
								It <= e && e < t
									? (zi(n, "tns-moving"), (n.style.left = (100 * (e - It)) / rt + "%"), zi(n, P), Wi(n, W))
				...
				if ("prev" === t) oi(e, -1);
					...
					if (
						("first" === t
							...
							: "last" === t
							? (i = I ? Q - rt - n : Q - 1 - n)
							: ("number" != typeof t && (t = parseInt(t)), isNaN(t) || (e || (t = Math.max(0, Math.min(Q - 1, t))), (i = t - n))),
						!I && i && Math.abs(i) < rt)
					) {
						var a = 0 < i ? 1 : -1;
